...
int main(int argc, char **argv)
{
  ...
  */
  MemDesc md(&particles.pos[0].x, 4,                         0, // pos x
             &particles.pos[0].y, 4,                         0, // pos y
             &particles.pos[0].z, 4,                         0, // pos z
             &particles.vel[0].x, 3,                         0, // vel x
             &particles.vel[0].y, 3,                         0, // vel y
             &particles.vel[0].z, 3,                         0, // vel z
             &particles.pos[0].w, 4,                         0, // weight
             N,
             recordsCount);
